        ...
        <Header className="flex justify-between items-center bg-white dark:bg-gray-800">
            ...
            <div className="flex items-center">
                <Menu mode="horizontal" className="border-0 ">
                    ...
                    <Menu.Item key="github" className="dark:bg-gray-800">
                        <a
                            href="https://github.com/CESSProject/storage-monitor"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-white bg-white dark:bg-gray-800 text-white"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                className="text-blue-500 dark:bg-gray-800 text-white"
                            >
